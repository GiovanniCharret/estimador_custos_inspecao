...
def _texto_leia_me():
    ...
    linhas = [
        ...
        "cresce ao dividir. O mapa mostra a divisao concreta e o km real de cada cenario",
        "(no rotulo do radio 'Equipes em campo'): compare com o cenario de 1 equipe antes",
        "de assumir o prazo curto. Os cenarios com mais de uma equipe sao, portanto,",
        "OTIMISTAS - o custo real de encurtar o prazo e' maior do que a tabela mostra.",
        "",
